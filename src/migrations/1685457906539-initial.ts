...
export class Initial1685457906539 implements MigrationInterface {
    name = 'Initial1685457906539'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customers" ADD "customer_id" SERIAL NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "customers" ADD "id" integer NOT NULL DEFAULT nextval('customers_customer_id_seq')`);
