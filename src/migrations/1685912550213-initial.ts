...
export class Initial1685912550213 implements MigrationInterface {
    name = 'Initial1685912550213'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "customer" integer`);
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_5c90dd8d5bb817724bf6d97eb49" FOREIGN KEY ("customer") REFERENCES "customers"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "customer"`);
        await queryRunner.query(`ALTER TABLE "orders" ADD "customer" text NOT NULL`);
