...
export class Initial1685668370902 implements MigrationInterface {
    name = 'Initial1685668370902'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "category"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "category" integer NOT NULL`);
    }
