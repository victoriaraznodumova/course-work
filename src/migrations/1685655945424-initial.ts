...
export class Initial1685655945424 implements MigrationInterface {
    name = 'Initial1685655945424'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "feedbacks" ADD "orderId" integer NOT NULL`);
    }
