...
export class Initial1685652904797 implements MigrationInterface {
    name = 'Initial1685652904797'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "feedbacks" DROP COLUMN "order"`);
        await queryRunner.query(`ALTER TABLE "orders" DROP COLUMN "feedback"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "orders" ADD "feedback" integer`);
