...
export class Initial1685485575043 implements MigrationInterface {
    name = 'Initial1685485575043'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "orders" ADD "categoryId" integer`);
        await queryRunner.query(`ALTER TABLE "feedbacks" ADD "customer_id" integer NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "feedbacks" DROP COLUMN "customer_id"`);
